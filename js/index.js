const form = document.querySelector('.form'),
  formFieldsets = document.querySelectorAll('.form__fieldset'),
  formBtnPrev = document.querySelector('.form__btn-prev'),
  formBtnNext = document.querySelector('.form__btn-next'),
  formBtnSubmit = document.querySelector('.form__btn-submit');
